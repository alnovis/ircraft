package io.alnovis.ircraft.core.semantic.expr
  ...
  given ContentHashable[Expression] with
    ...
    def contentHash(a: Expression): Int =
      ...
      a match
        ...
        case NewInstance(t, args) =>
          ContentHash.combine(5, typeRefHash.contentHash(t), ContentHash.ofList(args)(using this))
