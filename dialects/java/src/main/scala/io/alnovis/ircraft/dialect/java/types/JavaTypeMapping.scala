...
object JavaTypeMapping:
  ...
  def toBoxedJavaType(ref: TypeRef): String = ref match
    case PrimitiveType.Int32 | PrimitiveType.SInt32 | PrimitiveType.SFixed32 |
         PrimitiveType.UInt32 | PrimitiveType.Fixed32                        => "Integer"
    case PrimitiveType.Int64 | PrimitiveType.SInt64 | PrimitiveType.SFixed64 |
         PrimitiveType.UInt64 | PrimitiveType.Fixed64                        => "Long"
    case PrimitiveType.Float32                                                => "Float"
    case PrimitiveType.Float64                                                => "Double"
    case PrimitiveType.Bool                                                   => "Boolean"
